...
| # | Module | Target | Status | Spec |
|---|---|---|---|---|
| 08 | On-device ONNX ID (EfficientNet-Lite0 base) | v0.3 | planned | — |
| 09 | Offline map tile download (Mexico pmtiles) | v0.3 | planned | — |
| 10 | EXIF/XMP/ID3 auto-extraction | v0.3 | planned | — |
| 11 | NOM-059 / CITES obscuration grid enforcement | v0.3 | planned | — |

## v0.5 — Beta

| # | Module | Target | Status | Spec |
|---|---|---|---|---|
| 12 | BirdNET audio ID (requires Cornell commercial license) | v0.5 | planned | — |
| 13 | Multi-image observations | v0.5 | planned | — |
| 14 | Ecological evidence fields (tracks, scat, substrate) | v0.5 | planned | — |
| 15 | Rastrum Scout v0 (conversational, pgvector RAG) | v0.5 | planned | — |
| 16 | Research-grade consensus (2/3 identifier workflow) | v0.5 | planned | — |
| 17 | Regional ONNX packs (Oaxaca, Yucatán) | v0.5 | planned | — |
| 18 | GBIF IPT pilot + Darwin Core Archive ZIP | v0.5 | planned | — |
| 19 | Local Contexts BC/TK Notices integration | v0.5 | planned | — |

## v1.0 — Public launch

| # | Module | Target | Status | Spec |
|---|---|---|---|---|
| 20 | Camera trap ingestion (SpeciesNet + MegaDetector) | v1.0 | planned | — |
| 21 | Video support (≤30 s, H.265/AV1) | v1.0 | planned | — |
| 22 | Opt-in gamification (no leaderboards) | v1.0 | planned | — |
...
| 26 | Community profiles, badges, BioBlitz events | v1.0 | planned | — |
| 27 | Capacitor iOS wrapper | v1.2 | planned | — |

## v1.5 — Territory layer (parallel to v1.0)

| # | Module | Target | Status | Spec |
|---|---|---|---|---|
| 28 | Biodiversity Trails (GPS waypoints + diversity metrics) | v1.5 | planned | — |
| 29 | PITs + QR/NFC anchors (Puntos de Información Territorial) | v1.5 | planned | — |
| 30 | Spatial analysis (ANP/INEGI/INAH GeoJSON layers) | v1.5 | planned | — |
| 31 | Diversity indices (S, H′, D, Chao1, Pielou J) | v1.5 | planned | — |
| 32 | Trail PDF export (field-guide style) | v1.5 | planned | — |

## v2.0 — Institutional

| # | Module | Target | Status | Spec |
|---|---|---|---|---|
| 33 | Camera trap advanced (occupancy, activity histograms) | v2.0 | planned | — |
| 34 | GBIF publisher + DOI generation | v2.0 | planned | — |
| 35 | Regional ML training pipeline (see module 07 for gates) | v2.0 | planned | — |
| 36 | B2G dashboard (CONANP / state agencies) | v2.0 | planned | — |
| 37 | iNaturalist import/export bridge | v2.0 | planned | — |

## v2.5 — AI + AR

| # | Module | Target | Status | Spec |
|---|---|---|---|---|
| 38 | Rastrum Scout full (conversational field AI) | v2.5 | planned | — |
| 39 | AR species overlay | v2.5 | planned | — |
| 40 | Indigenous language voice I/O | v2.5 | planned | — |
| 41 | CONABIO / CONANP / INAH partnership APIs | v2.5 | planned | — |
